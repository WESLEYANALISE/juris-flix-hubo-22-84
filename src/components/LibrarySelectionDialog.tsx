          ...
          {libraryOptions.map((option) => {
            ...
            return (
              <div
                ...
                className="cursor-pointer rounded-xl p-4 transition-all duration-300 hover:scale-[1.02] bg-white/10 hover:bg-white/20 shadow-md hover:shadow-lg group backdrop-blur-sm border border-white/10"
              >
